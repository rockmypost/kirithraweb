      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <div className="hidden md:block absolute left-[27px] top-8 bottom-8 w-[2px] bg-primary/30" />
              ...
              {process.steps.map((step, index) => (
                ...
                >
                  <div className="flex gap-4 md:gap-6 items-start">
                    {/* Number badge with solid color */}
                    <motion.div 
                      className="flex-shrink-0 relative z-10"
                      whileHover={{ scale: 1.1 }}
                      transition={{ duration: 0.3 }}
                    >
                      <div className="w-14 h-14 rounded-full bg-primary flex items-center justify-center font-bold text-white shadow-lg shadow-primary/25 group-hover:shadow-xl group-hover:shadow-primary/40 transition-all duration-300">
                    ...
                    <motion.div 
                      className="flex-1 bg-background rounded-xl p-6 md:p-8 border border-border/50 shadow-sm group-hover:shadow-md group-hover:border-primary/20 transition-all duration-300"
                      whileHover={{ y: -4 }}
                      transition={{ duration: 0.3 }}
                    >
